...
# from scripts.database.mongo.ilens_configuration.collections.user_project import (
#     UserProject,
# )
from scripts.db_connections.redis_connection import user_role_permissions_redis
